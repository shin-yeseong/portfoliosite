  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="z-10"
      >
        <h2 className="text-5xl font-extrabold text-darkBg dark:text-lightBg mb-4 tracking-tight">Education</h2>
        <p className="text-lg text-darkSecondaryBg dark:text-lightSecondaryBg text-center">배움의 여정과 성장 기록</p>
      </motion.div>
      ...
      >
        ...
        <motion.div className="relative flex items-start gap-8" variants={itemVariants}>
          ...
          <div className="bg-lightSecondaryBg/80 dark:bg-darkSecondaryBg/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-lightSecondaryBg dark:border-darkSecondaryBg w-full">
            <p className="text-sm font-semibold text-accentBlue dark:text-lightSecondaryBg mb-1">{education.period}</p>
            <h3 className="text-2xl font-bold text-darkBg dark:text-lightBg">{education.university}</h3>
            <p className="text-md text-darkSecondaryBg dark:text-lightSecondaryBg font-medium mb-4">{education.major}</p>
            <p className="text-darkSecondaryBg dark:text-lightSecondaryBg leading-relaxed mb-6">{education.desc}</p>
