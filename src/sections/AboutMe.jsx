...
export default function AboutMe() {
  return (
    ...
    >
      ...
      <motion.h2
        variants={itemVariants}
        className="text-3xl md:text-5xl font-extrabold text-darkBg dark:text-lightBg mb-1 text-center"
      >
        성장을 즐기는 개발자, 신예성입니다
      </motion.h2>
      {/* 주요 키워드 */}
      ...
      <motion.p
        variants={itemVariants}
        className="max-w-4xl text-lg text-darkSecondaryBg dark:text-lightSecondaryBg text-center leading-relaxed mb-2"
      >
